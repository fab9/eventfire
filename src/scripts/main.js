...
EventFire.prototype.loadMessages = function() {
  ...
  var setMessage = function(data) {
    var val = data.val();
    this.displayMessage(data.key, val.name, val.text, val.title, val.location, val.photoUrl, val.imageUrl);
  }.bind(this);
...
EventFire.prototype.displayMessage = function(key, name, text, title, location, picUrl, imageUri) {
